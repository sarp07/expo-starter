...
const Starter: React.FC<Props> = ({ navigation }) => {
      ...
      <View style={styles.insideContainer}>
        ...
        <View style={styles.buttonBiggerContainer}>
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("PasskeyLogin")}>
              <Text style={styles.buttonText}>Login via PassKey</Text>
            </TouchableOpacity>
          </View>
        </View>
